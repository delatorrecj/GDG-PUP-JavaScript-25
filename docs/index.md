# Documentation Index: Webverse Vol.2 JavaScript Study Jam

**Project slug:** `gdg-pup-javascript-25`
...
List only artifacts that exist. Empty FMD suites are intentional for teaching repos.
...
No PRD/SDD/QAD suite for this teaching repo. FMD philosophy: INDEX is inventory, STATE is position, FLAGS holds improvement backlog.
